class card extends HTMLElement {
    ...
    bgcolor(){
        const color = this.getAttribute('data-bgcolor') ?? "#0015"
    ...
    image(){
        const imagem = this.getAttribute('data-bgname') ?? "url(./img/6.png)"
    ...
    status(){
        const statusAluno = this.getAttribute('data-bgstatus')?? "situacao"
        return statusAluno
    }
}
